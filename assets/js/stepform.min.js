$(function() {
  ...
  $('#Keychain').click(function() {
    document.getElementById('pinform').style.display = "none";
    document.getElementById('coinform').style.display = "none";
    document.getElementById('chainform').style.display = "block";
    document.getElementById('choice').style.display = "none";
    document.getElementById('rstbtn').style.display = "block";
  });
  // Reset Button
  ...
  // Expand Button
  $('#expndbtn').click(function () {
    document.getElementById('sidebar').style.display = "none";
    document.getElementById('expndbtn').style.display = "none";
    document.getElementById('shrinkbtn').style.display = "block";

  });
  $('#shrinkbtn').click(function () {
    document.getElementById('sidebar').style.display = "block";
    document.getElementById('expndbtn').style.display = "block";
...
// Start Lapel Pin Triggers
  ...
  // pin sizing
  $('#size075p, #size175p, #size200p, #size225p, #size250p').click(function () {
